...
public class GetIdPostServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ResultSet resultSet = dbUtillrz.queryDate("select post_title,post_text,post_time,number_likes,number_comments,number_reprints,user_name,name from post,user where post_id='"+id+"' and post.user_id = user.user_id");
